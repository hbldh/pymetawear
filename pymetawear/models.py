...
class MetaWearBoard(object):

    def __init__(self):
        self.name = 'MetaWearBoard'
        self.id = -1
        self.model_nbr = None
        self.services = None
...
class MetaWearRG(MetaWearBoard):

    def __init__(self):
        super(MetaWearRG, self).__init__()
        self.name = 'MetaWear RG'
        self.id = 1
        self.model_nbr = create_string_buffer(b'1', 1)
        self.services = {
...
class MetaWearR(MetaWearBoard):

    def __init__(self):
        super(MetaWearR, self).__init__()
        self.name = 'MetaWear R'
        self.id = 0
        self.model_nbr = create_string_buffer(b'0', 1)
        self.services = {
            0x01: create_string_buffer(b'\x01\x80\x00\x00', 4),
            0x02: create_string_buffer(b'\x02\x80\x00\x00', 4),
...
class MetaWearRPro(MetaWearBoard):

    def __init__(self):
        super(MetaWearRPro, self).__init__()
        self.name = 'MetaWear R Pro'
        self.id = 2
        self.model_nbr = create_string_buffer(b'1', 1)
        self.services = {
            0x01: create_string_buffer(b'\x01\x80\x00\x00', 4),
